...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div className="group shadow-one hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark relative h-full overflow-hidden rounded-lg border border-gray-200 bg-white duration-300 dark:border-white/10">
